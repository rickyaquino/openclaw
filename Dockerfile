...
# Using COPY instead of --mount=type=bind for Railway compatibility.
...
RUN --mount=type=cache,id=s/38ef93ea-7a8f-4411-ba1a-e4a8de4107dd-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/38ef93ea-7a8f-4411-ba1a-e4a8de4107dd-/var/cache/apt,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/38ef93ea-7a8f-4411-ba1a-e4a8de4107dd-/var/lib/apt,target=/var/lib/apt,sharing=locked \
    apt-get update && \
